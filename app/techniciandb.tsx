...
const TechnicianDashboard = () => {
  ...
  const fetchTechnicianTasks = async () => {
    ...
    try {
      ...
      const response = await fetch(
        "https://stratoliftapp.vercel.app/api/tasks",
        {
          method: "GET",
          headers: {
  ...
  const StatCard = ({ title, value, icon, color, bgColor }) => (
    ...
    >
      <View className="flex-row items-center mb-2">
        <View className={`${color} p-2 rounded-lg mr-2`}>{icon}</View>
      </View>
  ...
  return (
    <View className="flex-1 bg-gray-50">
      ...
      {/* Header Section */}
      <LinearGradient colors={["#ffffff", "#fafafa"]} className="pt-2 pb-4">
        <View className="flex-row justify-between items-center px-5 pb-1">
          <View className="flex-row items-center">
            ...
            <View>
              ...
              <Text className="text-lg font-geist-bold text-gray-800">
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <Text className="text-white font-geist-semibold mr-2">
                View Schedule
              </Text>
        ...
        <View className="px-5 mb-6">
          <Text className="text-lg font-geist-bold text-gray-800 mb-4">
            Task Summary
          </Text>
        ...
        <View className="px-5 mb-6">
              ...
              {filterMenuVisible && (
                ...
                >
                  ...
                  <Pressable
                    ...
                    className="px-4 py-2.5 border-b border-gray-100"
                  >
                    <Text className="text-gray-700 font-geist">
                      In Progress
                    </Text>
                  </Pressable>
                  <Pressable
          ...
          {loading ? (
            <View className="bg-white rounded-2xl p-8 items-center justify-center shadow-sm">
              ...
              <Text className="text-gray-500 mt-3 font-geist">
                Loading tasks...
              </Text>
            </View>
          ) : error ? (
            <View className="bg-white rounded-2xl p-8 items-center justify-center shadow-sm">
              ...
              <Text className="text-gray-700 font-geist-bold mb-1">
                  ...
                  <View className="flex-row justify-between items-start">
                    <View className="flex-row flex-1 mr-2">
                      ...
                      <View className="flex-1">
                        ...
                        <Text
                          numberOfLines={2}
                          className="text-gray-500 text-xs font-geist mb-2"
                        >
                          {task.description}
                        </Text>
                        ...
                        <View className="flex-row items-center justify-between">
                          <View className="flex-row">
                            <View
                              className={`py-1 px-2.5 rounded-full ${getStatusColor(task.status).split(" ")[0]} mr-2`}
                            >
                              <Text
                                className={`text-xs font-geist ${getStatusColor(task.status).split(" ")[1]}`}
                              >
                            ...
                            {task.priority && (
                              <View
                                className={`py-1 px-2 rounded-full ${getPriorityColor(task.priority).split(" ")[0]}`}
                              >
                                <Text
                                  className={`text-[10px] font-geist ${getPriorityColor(task.priority).split(" ")[1]}`}
                                >
            ...
            <View className="bg-white rounded-2xl p-8 items-center justify-center shadow-sm">
              ...
              />
              <Text className="text-gray-700 font-geist-semibold mb-1">
                No tasks found
              </Text>
              <Text className="text-gray-500 text-center mb-4 font-geist">
                {activeFilter === "all"
      ...
      >
        <Pressable className="items-center px-3">
          ...
          <Text className="text-xs mt-1 text-blue-600 font-geist-semibold">
            Dashboard
          </Text>
        </Pressable>
        <Pressable
        ...
        >
          ...
          <Text className="text-xs mt-1 text-gray-500 font-geist">
            Clock-in
          </Text>
        </Pressable>
        <Pressable
