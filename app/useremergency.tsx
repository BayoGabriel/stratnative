          ...
          <ScrollView className="flex-1">
            <View className="flex-1 bg-white p-4">
              ...
              <View className="flex-row items-center mb-4">
                ...
                <Text className="text-lg font-semibold">Emergency Request</Text>
              </View>
        ...
        return (
          <View className="flex-1 bg-white p-4">
            ...
            <ScrollView className="flex-1">
              ...
              <View className="mb-2">
                <Text className="text-gray-500 mb-1">Issue Type</Text>
                <Text className="mb-4 capitalize">Emergency</Text>
              </View>
        ...
        return (
          <View className="flex-1 bg-white justify-center items-center p-4">
            ...
            <Text className="text-center text-gray-500 mb-12">
              Your emergency request has been submitted and is now pending. You will be notified once it's assigned.
            </Text>
